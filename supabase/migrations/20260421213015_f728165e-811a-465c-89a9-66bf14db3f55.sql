DROP FUNCTION IF EXISTS public.update_organization_details(text, text, text, text, uuid);
DROP FUNCTION IF EXISTS public.update_organization_details(text, text, text, text);
