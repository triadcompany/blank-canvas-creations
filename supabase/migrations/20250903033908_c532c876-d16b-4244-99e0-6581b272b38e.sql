...
-- Primeiro, criar uma pipeline padrão para cada organização que tem estágios
...
JOIN profiles p ON ps.created_by = p.id
...
-- Associar estágios existentes às pipelines padrão
