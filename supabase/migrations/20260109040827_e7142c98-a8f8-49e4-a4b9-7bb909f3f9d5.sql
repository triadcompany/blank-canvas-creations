-- Fix signup failure: handle_new_user runs under RLS and cannot INSERT into organizations/profiles/user_roles.
-- Recreate function with row_security disabled for the duration of the function.
