...
BEGIN
  ...
  INSERT INTO pipeline_stages (name, position, color, pipeline_id, created_by, is_active) VALUES
    ...
    ('Negociando',         4,  '#EC4899', v_pipeline_id, v_profile_id, true),
    ('Agendado',           5,  '#F59E0B', v_pipeline_id, v_profile_id, true),
    ('Visita Realizada',   6,  '#8B5CF6', v_pipeline_id, v_profile_id, true),
    ...
    ('Desqualificado',     10, '#9CA3AF', v_pipeline_id, v_profile_id, true);
