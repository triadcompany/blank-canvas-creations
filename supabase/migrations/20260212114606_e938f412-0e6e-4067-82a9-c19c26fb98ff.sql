...
-- Schedule process-event-dispatch to run every minute
SELECT cron.schedule(
  'process-event-dispatch-every-minute',
  '* * * * *',
  $$
  SELECT net.http_post(
    url := 'https://tapbwlmdvluqdgvixkxf.supabase.co/functions/v1/process-event-dispatch',
