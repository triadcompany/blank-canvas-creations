...
import { Brain, TrendingUp, TrendingDown, Minus, AlertTriangle, AlertCircle, Info } from 'lucide-react';
...
export function ConversationIntelligenceBadge({
  ...
  return (
    <TooltipProvider>
      <div className="flex items-center gap-1.5 px-4 py-1.5 border-b border-border bg-muted/20">
